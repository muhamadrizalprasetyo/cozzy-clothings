    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-cozzy-800 border-r border-cozzy-700 hidden md:flex flex-col shadow-2xl z-20">
            ...
            <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-cozzy-accent text-cozzy-900 font-medium transition-all duration-200">
                    <i class="ph ph-squares-four text-xl"></i>
                    Dashboard
                </a>
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-cozzy-accent hover:bg-cozzy-700 font-medium transition-all duration-200">
            ...
            <div class="p-4 border-t border-cozzy-700">
                <div class="flex items-center gap-3 px-4 py-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-cozzy-accent">Admin</p>
                        <p class="text-xs text-gray-500 cursor-pointer hover:text-red-400 transition">Log out</p>
                    </div>
                </div>
            </div>
        </aside>
